...
>(({ className, children, ...props }, ref) => {
  // Detect if we're in RTL mode by checking the document direction
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        isRtl && "text-right rtl-select-trigger",
        className
      )}
      {...props}
    >
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        isRtl ? "pr-8 pl-2 text-right rtl-select-item" : "pl-8 pr-2",
        className
      )}
      {...props}
    >
