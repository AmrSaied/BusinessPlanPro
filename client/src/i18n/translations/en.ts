export default {
  ...
  payment: {
    ...
    stripePayment: 'Card Payment',
    standardPayment: 'Standard Payment',
    testMode: 'Test Mode',
    testModeDescription: 'No actual payment will be processed in test mode',
    securePayment: 'Your payment information is processed securely',
    ...
    testModeSuccess: 'Test payment completed successfully',
    realModeSuccess: 'Payment processed successfully',
  ...
  document_purpose_notice: 'This document is intended for {{travelPurpose}} purposes only and is not a valid boarding pass.',
  dummy_ticket_notice: 'For visa application purposes only - Not a valid ticket',
  boarding_pass: 'Boarding Pass',
  ticket_number: 'Ticket Number',
  scan_for_boarding: 'Scan for boarding',
  ticket_disclaimer: 'This is a simulated flight ticket for visa/travel purposes only',
  global_air_travel: 'Global Air Travel Services',
  not_valid_for_travel: 'Not valid for actual travel',
  customer_support: 'Customer Support',
  legal: 'Legal',
  disclaimer: 'Disclaimer',
  issuer: 'Issuer',
  global_air_travel_ltd: 'Global Air Travel Ltd.',
  booking_street: 'Booking Street',
  london: 'London',
